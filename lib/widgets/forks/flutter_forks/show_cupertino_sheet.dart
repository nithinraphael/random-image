// NOTE: This is forked from https://gist.github.com/leredirect/c5904d9c611388cf6c08449dccc1e91b
// because of this issue: https://github.com/flutter/flutter/issues/161687
...
/// will be shown with no [Navigator] widget. Multiple calls to `showCupertinoSheetMOD`
/// can still be made to show multiple stacked sheets, if desired.
///
/// `showCupertinoSheetMOD` always pushes the [CupertinoSheetRoute] to the root
...
///
/// {@tool dartpad}
/// This example shows how to navigate to use [showCupertinoSheetMOD] to display a
...
Future<T?> showCupertinoSheetMOD<T>({
  ...
  static Widget delegateTransition(
    ...
    final Animatable<BorderRadiusGeometry> decorationTween =
        Tween<BorderRadiusGeometry>(
          ...
          end: BorderRadius.circular(config.Spacing.borderRadiusXxxl),
        );
...
///
/// Typically called by [showCupertinoSheetMOD], which provides some boilerplate for
...
///
/// See also:
///   * [showCupertinoSheetMOD], which is a convenience method for pushing a
...
class _CupertinoDownGestureDetectorState<T>
  ...
  late _CupertinoDownGestureController<T> _downGestureController = widget
      .onStartPopGesture();
...
class _CupertinoDownGestureController<T> {
  ...
  void dragEnd(double velocity) {
    ...
    if (!isCurrent) {
      ...
      animateForward = controller.value > 0.9;
    }
